						...
						<div class="row">
							<div class="col">
                                ...
                                <div class="media mb-3 mt-5">
                                    <img class="mr-2 img-thumbnail" height="15%" width="15%"
                                        ...
                                        <div class="media-body ml-2">
                                            <p class="mt-0">
                                                ...
                                                <br />
                                                    ...
                                                    <br/>
                                                    <small class="text-muted">Pages: <?php echo $row['page']; ?></small>
                                                <br />
                                            <div class='mb-2 mt-2'>
                                                    ...
                                                    <span class="badge badge badge-light" data-toggle="tooltip"
                                                        data-placement="top" title="Full Text Requests"><span
                                                ...
                                                <div class="btn-group mt-5" role="group" aria-label="Basic example">
                                                    <button type="button" class="btn btn-sm btn-primary mr-2 pr-3 pl-3"  onclick="get_download_id(<?php echo $row['id'];?>)" data-toggle="modal" data-target="#client_modal"><span class="oi oi-data-transfer-download"></span> Download</button>
                                                    <button type="button" class="btn btn-sm btn-outline-dark mr-2 pr-3 pl-3" get_download_id onclick="get_download_id(<?php echo $row['id'];?>,'hits','<?php echo $row['file'];?>')"
                                                ><span class="oi oi-eye"></span> Abstract</button>
                                                    <button type="button" class="btn btn-sm btn-outline-dark pr-3 pl-3"  data-toggle="modal" data-target="#citationModal" onclick="get_citee_info('<?php echo addslashes($row['cite']); ?>','<?php echo $row['id'];?>')"><span class="oi oi-document"></span> Cite</button>
                                                </div>
