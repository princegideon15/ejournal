...
$(document).ready(function()
{
  ...
  // set editableSelect plugin effects to slide
  // $('#jor_volume').editableSelect({ effects: 'slide' });
  ...
  if(prv_exp == 0){
    $('#table-citees').DataTable({"order":[[0, "asc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }] });
  }
  else{
  $('#table-citees').DataTable({
    "order":[[0, "asc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }],
        dom: 'lBfrtip',
        buttons: [
              {
                extend: 'copy',
  ...
  // check and display export button if privilege to export is enabled
  if(prv_exp == 0){
    $('#table-all-articles').DataTable({"order":[[1, "asc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }] });
  }
  else{
    $('#table-all-articles').DataTable({
          "order":[[1, "asc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }],
          dom: 'lBfrtip',
          buttons: [
                {
                  extend: 'copy',
  ...
  // check and display export button if privilege to export is enabled
  if(prv_exp == 0){
      $('#table-journals').DataTable({"order":[[1, "desc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }] });
  }
  else{
    $('#table-journals').DataTable({
          "order":[[1, "desc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }],
          dom: 'lBfrtip',
          buttons: [
                 {
                  extend: 'copy',
  ...
  var tjor = $('#table-journals').DataTable();
              ...
              //     tjor.column(0, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
              //         cell.innerHTML = i+1;
              //     } );
              // } ).draw();
              ...
              tjor.on('draw', function () {
                tjor.rows({ search: 'applied', order: 'applied', filter: 'applied' }).data().each(function (d, i) {
                    d[0] = i + 1;
                });
            });
  ...
  // check and display export button if privilege to export is enabled
  if(prv_exp == 0){
    $('#table-popular').DataTable({"order":[[3, "desc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }]});
  }
  else{
    $('#table-popular').DataTable({
          "order":[[3, "desc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }],
          dom: 'lBfrtip',
          buttons: [
                 {
                  extend: 'copy',
    ...
    var tpop = $('#table-popular').DataTable();
                ...
                tpop.on('draw', function () {
                    tpop.rows({ search: 'applied', order: 'applied', filter: 'applied' }).data().each(function (d, i) {
                        d[0] = i + 1;
                    });
                });
  ...
  if(prv_exp == 0)
  {
     $('#table-clients').DataTable({"order":[[3, "desc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }]});
  }
  else{
  ...
  var tcli = $('#table-clients').DataTable();
              ...
              tcli.on('draw', function () {
                  tcli.rows({ search: 'applied', order: 'applied', filter: 'applied' }).data().each(function (d, i) {
                      d[0] = i + 1;
                  });
              });
  ...
  if(prv_exp == 0)
  {
      $('#table-viewers').DataTable({"order":[[3, "desc"]], retrieve:true, "columnDefs":[{ "targets":0, "orderable":false }]});
  }
  else{
...
// initiate and disable sorting on clicking first column first row 
  var tedt = $('#table-editorials').DataTable();
              tedt.on( 'order.dt search.dt', function () {
                  tedt.column(0, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
                      cell.innerHTML = i+1;
                  } );
              } ).draw();
  // check and display export button if privilege to export is enabled
  ...
  $("#add_editorial_form").validate({
                                      ...
                                      submitHandler: function() {
                                        ...
                                        $.ajax({
                                          url : base_url + "admin/dashboard/editorial/",
  ...
  // add journal with validations in modal
  ...
  $("#form_home").validate({
                            ...
                            submitHandler: function() {
                              ...
                              if(file_size_pdf < 20000000){ $('#upload_cfp').next('.badge-danger').hide(); }
                              // if file size of image is less than 20mb hide warning
                              if(file_size_img < 2000000){ $('#upload_cfpi').next('.badge-danger').hide(); }
  ...
  $("#form_guidelines").validate({
                                  ...
                                  submitHandler: function() {
                                    ...
                                    var file_size = $('#upload_guidelines')[0].files[0].size;
                                     ...
                                     // if file size of pdf is less than 20mb hide warning
                                    if(file_size < 20000000){ $('#upload_guidelines').next('.badge-danger').hide(); }
  ...
  $("#form_create_journal").validate({
                                      ...
                                      submitHandler: function() {
                                        ...
                                        var file_size = ($('#jor_cover').val() != '') ? $('#jor_cover')[0].files[0].size : '';
                                         ...
                                         // if file size of pdf is less than 20mb hide warning
                                        if(file_size < 2000000){ $('#jor_cover').next('.badge-danger').hide(); }
  ...
  $("#form_add_article").validate({
                                    ...
                                    submitHandler: function() {
                                      ...
                                      // if file size of pdf is less than 20mb hide warning
                                      if(file_size_abs < 20000000){ $('#badge_pdf').next('.badge-danger').hide(); }
                                      // if file size of pdf is less than 20mb hide warning
                                      if(file_size_txt < 20000000){ $('#badge_text').next('.badge-danger').hide(); }
        ...
        $.ajax({
          ...
          function(data)
          {
            ...
            $.each(data.authors,function(key, val)
            {
              ...
              $('#table-registry').dataTable({ "order": [[1, "desc" ]], retrieve: true, "columnDefs": [ {
                "targets": 0,
                "orderable": false
                } ]}).fnAddData( [
                  '',
  ...
  {
    msgInterval = setInterval(function(){getMessages();},1000);
  });
...
function edit_journal(id, art=null)
{
  ...
  if(art > 0){ $('#journal_modal .btn-danger').hide(); }
  else { $('#journal_modal .btn-danger').show(); }
  ...
  $.ajax({
      ...
      success:
              function(data)
              {
                ...
                $('html,body').animate({scrollTop: $("#articles").offset().top -50},'fast');
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $.each(response, function(key, val){
        sex_values.push(val.total);
          sex_labels.push(val.sex);
          // sex_bgcolors.push('#000000'.replace(/0/g, function(){return (~~(Math.random()*16)).toString(16);}));
      });

      
      var bar = document.getElementById('client_bar_chart').getContext('2d');
      var barChart = new Chart(bar, {
          ...
          data: {
              ...
              datasets: [{
                  data: sex_values,
                  backgroundColor: sex_bgcolors,
                  borderColor: sex_bgcolors,
                  borderWidth: 1
              }]
          },
          options: {
      ...
      var pie = document.getElementById('client_pie_chart').getContext('2d');
