				...
				<div class="tab-pane fade show active " id="home" role="tabpanel" aria-labelledby="home">
					<div class="jumbotron shadow p-5 mb-5 bg-white rounded ">
						...
						<div class="row">
							<div class="col">
								<!-- Latest Articles -->
								<h2 class="mt-5 font-weight-bold mb-3">Latest Articles</h2>
								...
								<div class="media mb-3">
									...
									<div class="media-body">
										<p class="mt-0">
											<a href="javascript:void(0);" class="text-dark h5"
											...
											<!-- <a href="javascript:void(0);" data-toggle="modal"
												data-target="#citationModal"
												onclick="get_citee_info('<?php echo addslashes($row['cite']); ?>','<?php echo $row['id'];?>')"><span
													class="badge badge-light"><span class="oi oi-pin"></span> Cite this
													paper</span></a> -->
							...
							<div class="col">
								...
								<!-- <embed class="border border-secondary" WMODE="transparent" id="embed_cfp"
                                    src="<?php echo base_url('assets/uploads/DO_NOT_DELETE_callforpapers.pdf#toolbar=0&navpanes=0&scrollbar=0'); ?>"
                                    width="100%" height="950px" type="application/pdf"> -->
								<!-- <a role="button" class="btn btn-sm btn-secondary float-right"
                                    href="<?php echo base_url('assets/uploads/DO_NOT_DELETE_callforpapers.pdf'); ?>"
                                    download="Call_for_papers.pdf"><i class="oi oi-data-transfer-download"></i>
                                    Download</a> -->
								<?php } else {?>
								<img class="border border-secondary" id="embed_cfp"
									src="<?php echo base_url('assets/uploads/DO_NOT_DELETE_callforpapers.jpg'); ?>"
								...
								<div class="mt-5">
									...
									<h2 class="mt-3 font-weight-bold mb-3">Top 10 Articles</h2>
										...
										<div class="media-body">
											<p class="mt-0">
												...
												<!-- <a href="javascript:void(0);" data-toggle="modal"
													data-target="#citationModal"
													onclick="get_citee_info('<?php echo addslashes($row['cite']); ?>','<?php echo $row['id'];?>')"><span
														class="badge badge-light"><span class="oi oi-pin"></span> Cite
														this
														paper</span></a> -->
