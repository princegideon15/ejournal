...
<!-- NAVIGATION -->
	<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
			<a class="navbar-brand" href="javascript:void(0);"><img src="<?php echo base_url('assets/images/ejicon-07.png'); ?>" width="30" height="30" alt=""> eJournal <?php echo $this->session->userdata('_oprs_type'); ?></a>
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<a class="btn btn-link dropdown-item" data-toggle="modal" data-target="#database_modal"><span class="oi oi-hard-drive" style="width:20px"></span> Backup/Restore Database</a>
	...
	<div class="row ">
		...
		<div class="col-2">
			<div class="list-group list-group-flush sticky" id="list-tab" role="tablist" >
				...
				<?php if ($this->session->userdata('_oprs_username') == 'superadmin' || $this->session->userdata('_oprs_type_num') == 3) {?>
...
if (file_exists($filename . 'DO_NOT_DELETE_callforpapers.pdf')) {?>
	...
	$pop[$c]['title'] = $row->art_title;?>
								...
								<div class="card-footer text-muted">
									Updated as of <?php echo date_format(new DateTime(date("Y-m-d H:i:s")), 'F j, Y, g:i a'); ?>
	...
	?>
		...
		((strpos($row->log_action, 'journal') !== false) ? 'edit_journal(' . $row->log_insert_id . ')' : '')
											...
											<a href="javascript:void(0);" onclick="<?php echo $onclick; ?>";? class="list-group-item list-group-item-action">
												<div class="media">
													...
													<div class="media-body">
														...
														<small class="text-muted ml-auto mt-0"><?php echo date_format(new DateTime($row->date_created), 'F j, Y, g:i a'); ?></small>
													</div>
												</div>
											</a>
											<?php endforeach;?>
				...
				<div class="tab-pane fade " id="create-journal-tab" role="tabpanel" aria-labelledby="create-journal-tab">
					<div class="jumbotron  text-white">
						<form id="form_create_journal">
							...
							<button type="submit" class="btn btn-primary" name="submit_journal"><span class="oi oi-check"></span> Save</button>
						</form>
					</div>
				</div>
				<!-- /.CREATE JOURNAL	 -->
				...
				<div class="tab-pane fade " id="add-article-tab" role="tabpanel" aria-labelledby="add-article-tab">
					<div class="jumbotron text-white">
						...
						<form id="form_add_article">
							...
							<button type="submit" class="btn btn-primary" name="submit_article"><span class="oi oi-check"></span> Save</button>
						</form>
					</div>
				</div>
				<!-- /.ADD ARTICLE -->
				...
				<div class="tab-pane fade" id="add-editorial-tab" role="tabpanel" aria-labelledby="add-editorial-tab">
					<div class="jumbotron text-white">
						<h1 class="h3">Add Editorial/Reviewer Information</h1>
						<hr class="my-4">
						<form id="add_editorial_form">
							<div class="form-row">
								<div class="form-group col-md-5">
									<label for="edt_position">Position</label>
									<input type="text" class="form-control" id="edt_position" name="edt_position" placeholder="ex. Editor/Editorial Board Member">
								</div>
								<div class="form-group col-md-5">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control" id="edt_affiliation" name="edt_affiliation">
								</div>
								<div class="form-group col-md-6">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<select class="form-control" id="edt_country" name="edt_country" placeholder="Select Country" style="background-color: white">
										<option value="">Select Country</option>
										<?php foreach ($country as $c): ?>
										d
										<?php $selected = '';
$field = 'edt_country';
if (!isset($_POST[$field])) {if ($c->country_id == '175') {$selected = 'selected';}}
echo '<option value=' . $c->country_id . ' ' . $selected . '>' . $c->country_name . '</option>';?>
							...
							<button type="submit" class="btn btn-primary" name="submit_editorial"><span class="oi oi-check"></span> Save</button>
						</form>
					</div>
				</div>
				<!-- /.ADD EDITORIAL -->
				...
				<div class="tab-pane fade " id="clients" role="tabpanel" aria-labelledby="clients" >
					<div class="jumbotron text-white">
													...
													<table id="table-clients" class="table table-hover" style="font-size:14px;table-layout: auto">
														<thead class="thead-dark">
															<tr>
																...
																<th scope="col">Articel Reference ID</th>
															</tr>
														</thead>
														<tbody>
															...
															<tr>
																...
																<td><?php echo date_format(new DateTime($c->clt_download_date_time), 'F j, Y, g:i a'); ?></td>
						...
						<div class="row">
						<div class="col-md-8">
							<canvas id="client_bar_chart"></canvas>
						</div>
						<div class="col-md-4">
							<canvas id="client_pie_chart"></canvas>
						</div>
						</div>
						</div>
						</div>
							...
							<table id="table-viewers" class="table table-hover" style="font-size:14px;table-layout: auto">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo date_format(new DateTime($v->date_viewed), 'F j, Y, g:i a'); ?></td>
...
?>
										...
										<td><?php echo date_format(new DateTime($j->date_created), 'F j, Y, g:i a'); ?></td>
										<td class='w-25'>
											<?php if ($this->session->userdata('_prv_edt') == 1) {?>
							...
							<table id="table-editorials" class="table table-hover" style="font-size:14px">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<button type="button" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-success btn-sm"><span class="oi oi-pencil" onclick="edit_editorial('<?php echo $e->edt_id; ?>')"></span></button>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-danger mr-auto" onclick="_remove('delete-editorial')">Remove Editorial</button>
						<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						<button type="submit" class="btn btn-primary">Save changes</button>
					</form>
				</div>
						...
						<tbody>
							...
							<tr>
								<td>
									...
									<td><?php echo date_format(new DateTime($row->date_created), 'F j, Y'); ?></td>
								</tr>
								<?php endforeach;?>
								<?php }?>
							</tbody>
...
<!-- /.feedback modal -->
	...
	<!-- <div class="modal fade" tabindex="-1" role="dialog" id="messageModal">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title text-uppercase message_username"></h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					<div id="message_body" style="word-break: break-all; word-wrap: break-word;overflow-y:scroll;padding-right:10px;max-height: 300px;font-size:20px"></div>
					<div class="input-group mb-3">
						<input type="text" class="form-control" id="type_message" placeholder="Type a message here" onkeydown="countChar(this)" maxlength="255">
						<div class="input-group-append">
