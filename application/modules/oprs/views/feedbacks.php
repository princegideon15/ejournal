<div class="container-fluid"  style="padding-top:3.5em">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <!-- Start<input type="date" id="min" name="min">
      End<input type="date" id="max" name="max"> -->
        <div class="tab-pane fade show active" id="uiux" role="tabpanel" aria-labelledby="uiux-tab">
          <div class="form-inline mt-3">
            <label class="font-weight-bold">Search Date of Feedbacks From</label>
            <input type="text" class="form-control w-25 mr-1 ml-1" id="min" name="min" placeholder="Start Date"> 
            to  
            <input type="text" class="form-control w-25 ml-1" id="max" name="max" placeholder="End Date">
            <button type="button" class="btn btn-primary ml-1" id="clear_filter">Reset</button>
          </div>
          
          <div class="table-responsive mt-3">
            <table class="table table-hover display nowrap" id="uiux_table" width="100%" cellspacing="0">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Name</th>
