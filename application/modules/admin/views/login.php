<body style="background-repeat: no-repeat;background-position: center center;background-size: cover;background: linear-gradient(to right, rgba(64,68,196,1) 0%, rgba(99,108,207,1) 100%),url('<?php echo base_url("assets/images/login-1.jpg"); ?>')'">
          ...
          <div class="card-body ">
            ...
            <div class="form-group">
              <div class="input-group mb-2">
                ...
                <input class="form-control" id="usr_username" name="usr_username" type="text" placeholder="Email" value="<?php if (isset($_COOKIE['oprs_cookie_user'])) {echo $_COOKIE['oprs_cookie_user'];}?>" required>
              </div> 
            </div>
